...
define({
	...
	"appid": "",
	"webmap": "6e03e8c26aad4b9c92a87c1063ddb0e3",  //basemap
	 ...
	 *
	 ***************************************************************************/
	"APP_TITLE": "Historic Map Explorer",
	...
	"HEADER_BACKGROUND_COLOR": "#162A4D",
	/* Header text color */
	"HEADER_TEXT_COLOR": "white",
	/* Header text size */
	"HEADER_TEXT_SIZE": "1.6em",
	/* Header text */
	"HEADER_TEXT": "Historic Map Explorer",
	...
	/* Subheader text */
	//"SUBHEADER_TEXT": "A demonstration by Esri",
	"SUBHEADER_TEXT": "",
	...
	/* Half circle */
	"HALF_CIRCLE_BACKGROUND_COLOR": "#162A4D",
	...
	"BASEMAP_INIT_LAT": 33.891717, //33.891717, 35.504335 Beirut
	"BASEMAP_INIT_LNG": 35.504335,
	"BASEMAP_INIT_ZOOM": 11,
	...
	*/
	...
	//"IMAGE_SERVER": "https://wdc-intel-ext.esri.com/server/rest/services/Lebanon/DRGs/ImageServer",
	"IMAGE_SERVER": "https://hphelps.esri.com/arcgis/rest/services/lebanon/ImageServer",
	/* outfields */
	"OUTFIELDS": ['*'],
	...
	"QUERY_TASK_URL": "http://hphelps.esri.com/arcgis/rest/services/Hosted/footprints2/FeatureServer/0",
	/* */
	//"QUERY_TASK_OUTFIELDS": ["Download_G", "Map_Name", "Map_Scale", "DateCurren", "SvcOID", "IsDefault", "Citation"],
	"QUERY_TASK_OUTFIELDS": ["map_name", "map_scale", "datecurren", "objectid", "citation"],
	//"SvcOID", download_g and IsDefault are missing and may screw everything up - heather

	/* A where clause for the query. */
	/* For the USGS application we're only pulling back the 'official' maps */
	//"QUERY_WHERE":"IsDefault = 1",
	"QUERY_WHERE":"1 = 1", //bs to keep it running heather

	/* The geometry to apply to the spatial filter. (<MAP_POINT> or < >) */
	"QUERY_GEOMETRY": "MAP_POINT",

	/* download location of maps - will need customization when on closed network */
	//"DOWNLOAD_PATH": "https://ims.er.usgs.gov/gda_services/download?item_id=",
	"DOWNLOAD_PATH": "http://www.esri.com",
	/* Attribute Fields */
	...
	"TOOLTIP_CONTENT": "",
	/* Download map link */
	"ATTRIBUTE_DOWNLOAD_LINK": "None", //"Download_G", -- changed/removed for sample application
	 ...
	 *
	 **************************************************************************/
	"DOWNLOAD_MAP_LABEL": "(download here)",
